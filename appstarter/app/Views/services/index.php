        ...
        <div class="row" id="tabs">
          ...
          <div class="col-md-8">
            <section class='tabs-content'>
              <article id='tabs-1'>
                <img src=" <?= base_url ('assets/images/single_service_01.jpg') ?> " alt="">
              ...
              <article id='tabs-2'>
                <img src=" <?= base_url ('assets/images/single_service_02.jpg') ?> " alt="">
              ...
              <article id='tabs-3'>
                <img src=" <?= base_url ('assets/images/single_service_03.jpg') ?> " alt="">
              ...
              <article id='tabs-4'>
                <img src=" <?= base_url ('assets/images/single_service_04.jpg') ?> " alt="">
